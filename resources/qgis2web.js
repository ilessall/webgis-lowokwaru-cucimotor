...
map.getView().fit([12529942.591327, -892688.409440, 12545126.109458, -883214.521106], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Persebaran Tempat Cuci Motor di Kecamatan Lowokwaru</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (495 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Tematik Persebaran Tempat Cuci Motor di Kecamatan Lowokwaru menampilkan sebaran lokasi usaha cuci motor yang terdapat di wilayah Kecamatan Lowokwaru. Peta ini disusun untuk menggambarkan pola persebaran spasial tempat cuci motor berdasarkan titik lokasi masing-masing usaha. Informasi yang ditampilkan dapat digunakan sebagai bahan analisis pelayanan jasa, perencanaan wilayah, serta pendukung pengambilan keputusan terkait pengembangan usaha dan fasilitas pendukung di Kecamatan Lowokwaru.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Lokasi_Cuci_Motor_Lowokwaru_10,
    colName: 'Lokasi',
    zoom: 10,
    collapsed: true,
    map: map,
